script_keys_init()
global.last_level_played=3 // zmieniaj to dla kazdego etapu, zmienna dla check pointa
global.level_death_pit=1280 // w jakim Y mario ma kusic od dziury
global.is_subplatforms=1
global.level_music=2
global.time=450
