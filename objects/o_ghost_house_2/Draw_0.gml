...
draw_sprite_ext(s_ghost_house_2,0,x,y,1+sin(koko)/20-sin(degtorad(efekter2))*efekter1/250,1-sin(koko)/20+sin(degtorad(efekter2))*efekter1/250,360+sin(koko/2)*5,c_white,1)
