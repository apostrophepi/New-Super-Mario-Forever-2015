...
draw_sprite_ext(global.buzzet_4,0,x+40,y+40,1.250-sin(degtorad(anim))/10,1.150-sin(degtorad(anim))/10,-sin(degtorad(anim*2))*10,c_white,0.74)
draw_sprite_ext(global.buzzet_4,0,x+40,y+40,1.250-sin(degtorad(anim))/10,1.150+sin(degtorad(anim))/10,sin(degtorad(anim*2))*10,c_white,0.74)
draw_set_blend_mode(bm_normal)


draw_sprite_ext(global.buzzet_4,0,x+40,y+40,1+sin(degtorad(anim))/5,1-sin(degtorad(anim))/5,sin(degtorad(anim))*10,c_white,1)
