...
if atakowanie>100 {draw_sprite_ext(global.gfx_troopa_arm_boomerang,0,-20+x+18,-40+y+10-15+sin(stream)+25,kierunek/2,1/2,sin(stream)*40+360+rzut_anim*kierunek,c_white,(atakowanie-100)/100)}
