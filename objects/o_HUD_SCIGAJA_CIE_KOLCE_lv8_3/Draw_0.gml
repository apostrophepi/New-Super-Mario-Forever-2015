...
karnof=(point_distance(obj_mario.x,obj_mario.y,(155067).x,(155067).y)/20)*global.ekran_size_act
karnof2=(-point_distance(obj_mario.x,obj_mario.y,(155067).x,(155067).y)/20)*global.ekran_size_act
...
draw_sprite_ext(global.gfx_disc_saw_1,0,karnof2+ixor,iyor,0.4,0.4,stream*5,c_white,1)
draw_sprite_ext(global.gfx_disc_saw_2,0,karnof2+xstart,ystart,promien/40,1,point_direction(xstart,ystart,ixor,iyor),c_white,1)
draw_sprite_ext(global.gfx_disc_saw_3,0,karnof2+ixor,iyor,0.4,0.4,0,c_white,1)
draw_sprite_ext(global.gfx_disc_saw_4,0,karnof2+ixor,iyor,0.4,0.4,stream*10,c_white,abs(sin(degtorad(stream*50)))/2)
draw_sprite_ext(global.gfx_disc_saw_4,0,karnof2+ixor,iyor,-0.4,0.4,stream*10,c_white,abs(sin(degtorad(stream*50)))/2)
