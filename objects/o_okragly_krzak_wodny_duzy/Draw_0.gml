...
draw_sprite_ext(global.water_okragly_krzak_wodny2,0,x,y,1+sin(degtorad(stream))/20,1-sin(degtorad(stream))/20,sin(degtorad(stream/5))*40-randomer+sin(degtorad(trzesator))*trzesator_promien,c_white,1)
