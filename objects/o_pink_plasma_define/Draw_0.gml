stream+=0.05
draw_sprite_ext(global.gfx_water_5,0,x,y+sin(stream)*5,image_xscale+1,image_yscale,0,c_white,0.75)
draw_sprite_ext(plasma_glow_effect,0,x,y+sin(stream)*5,image_xscale+1,image_yscale,0,c_white,1)
...
for (i=0;i<ceil(image_xscale/2);i+=1)
    {
    draw_sprite_ext(global.gfx_water_6,anim,x+i*80,y-80+sin(stream)*5,1,1,0,c_white,0.75)
    }
