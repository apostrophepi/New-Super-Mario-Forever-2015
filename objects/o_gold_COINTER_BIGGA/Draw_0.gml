...
if zniszczony_od_muszli=1 && coin_numba<20
    ...
    instance_create(x+40,y-16,o_block_killer)
    instance_create(x+80,y-16,o_block_killer)
    global.punkty+=200
    instance_create(x+40,y,o_COIN_SKACZACY_RAZ)
    }
...
if destroy=1 && coin_numba<20
    ...
    SXMS_SFX_PlayExt(20,((x-__view_get( e__VW.XView, 0 ))/800)*255,global.glosnosc_dzwieku,-1,0,0)
    coin_numba+=1
    if coin_numba>=20 {instance_create(x,y,o_point_brick_coiner_killed2);instance_destroy()}
    destroy=0
    bump=-40
    bump2=random(40)-random(40)
    bump3=0.05
