...
draw_sprite_ext(s_boo_oczy,stream,x+18+13*kierunek+znikacz_x,y+18-7+znikacz_y+sin(degtorad(stream*10))*5,kierunek+strzela_sizer/2*kierunek,1,strzela_sizer*20*kierunek,c_white,image_alpha)
