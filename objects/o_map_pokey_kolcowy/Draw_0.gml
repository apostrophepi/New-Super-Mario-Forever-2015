...
for (i=0;i<5;i+=1)
        ...
        draw_sprite_ext(global.gfx_enemy_pokey_5,0,x+sin(degtorad(stream*5+360*(i/(5+1))))*5,y-20*i-20,kierunek/2,1/2,360*(i/(5+1))+stream*2,c_white,1)
        }
    draw_sprite_ext(global.gfx_enemy_pokey_6,0,x+sin(degtorad(stream*5+i))*5,y-20*5-20,kierunek/2,1/2,sin(degtorad(stream*2+i))*3+360,c_white,1)
