...
if destroy=1 && killed=0
    ...
    SXMS_SFX_PlayExt(117,((x-__view_get( e__VW.XView, 0 ))/800)*255,global.glosnosc_dzwieku,-1,0,0)
    hoho=instance_create(x,y,o_point_block_killed_roslinker)
    hoho.dlugosc_roslinki=dlugosc_roslinki
    instance_destroy()
    }
}
