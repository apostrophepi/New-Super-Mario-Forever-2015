...
for(i=0;i<ceil(room_height/151)+1;i+=1)
    ...
    draw_sprite_ext(global.lava_falling,0,x,151*i-151*2+stream*2,2,1,0,c_white,0.5)
    draw_sprite_ext(global.lava_falling,0,x,151*i-151+stream,1,1,0,c_white,0.75)
    }    
    stream+=151/50
