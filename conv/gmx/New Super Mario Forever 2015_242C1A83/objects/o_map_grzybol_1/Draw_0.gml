...
draw_sprite_ext(s_map_grzybker_1,0,x,y,1-sin(koko)/15+sin(degtorad(efekter2))*efekter1/250,1-sin(koko)/15+sin(degtorad(efekter2))*efekter1/250,360+sin(koko/2)*10,c_white,1)
