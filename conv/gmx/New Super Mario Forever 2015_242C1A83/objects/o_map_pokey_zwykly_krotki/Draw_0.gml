...
for (i=0;i<3;i+=1)
        ...
        draw_sprite_ext(global.gfx_enemy_pokey_1,0,x+sin(degtorad(stream*3+360*(i/(3+1))))*3,y-20*i-20,kierunek/2,1/2,0,c_white,1)
        }
    draw_sprite_ext(global.gfx_enemy_pokey_2,0,x+sin(degtorad(stream*5+i))*3,y-20*3-20,kierunek/2,1/2,sin(degtorad(stream*2+i))*3+360,c_white,1)
