...
if x+image_xscale*40>__view_get( e__VW.XView, 0 ) && x<__view_get( e__VW.XView, 0 )+800*global.odleglosc_ekranu && y+image_yscale*40>__view_get( e__VW.YView, 0 ) && y<__view_get( e__VW.YView, 0 )+600*global.odleglosc_ekranu {
