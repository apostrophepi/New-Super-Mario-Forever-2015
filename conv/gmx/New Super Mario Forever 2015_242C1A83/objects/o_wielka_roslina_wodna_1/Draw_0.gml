...
draw_sprite_ext(global.water_roslinerker_1,0,x,y,1+sin(degtorad(stream))/10,1-sin(degtorad(stream))/5,sin(degtorad(stream/5))*10+sin(degtorad(trzesator))*trzesator_promien,c_white,1)
