...

{
    ...
    if animsek=2
        ...
        if sekwencor=101
            {
            animsek=0
            if !instance_exists(o_dialog2) {sekwencor=102;global.blocker_ruchow_anim=0;global.ster_up=vk_up;global.blokuj_ruch_na_title_screenie=0

global.ster_down=vk_down
global.ster_left=vk_left
global.ster_right=vk_right
global.ster_jump=ord("Z")
global.ster_fire=ord("X")
global.ster_pause=ord("P")}
            }
        if sekwencor=102
            {
            animsek=0
