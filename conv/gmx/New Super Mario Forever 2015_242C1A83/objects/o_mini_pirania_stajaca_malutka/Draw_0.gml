...
draw_sprite_ext(s_pirania_1,0,x+sin(degtorad(kierunek_wychodzenia+180))*poszedl,y+cos(degtorad(kierunek_wychodzenia+180))*poszedl,1/2,1/2,kierunek_wychodzenia+sin(degtorad(anim+180))*20-20,c_white,1)
draw_sprite_ext(s_pirania_2,0,x+sin(degtorad(kierunek_wychodzenia+180))*poszedl,y+cos(degtorad(kierunek_wychodzenia+180))*poszedl,1/2,1/2,kierunek_wychodzenia-sin(degtorad(anim+180))*20+20,c_white,1) 
