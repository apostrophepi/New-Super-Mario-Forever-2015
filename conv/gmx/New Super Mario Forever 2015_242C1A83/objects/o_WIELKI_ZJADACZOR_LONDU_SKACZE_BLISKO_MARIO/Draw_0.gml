...
if global.pauza=0
    ...
    if sekwencja=1 {y+=grawitacja; grawitacja+=0.05; if y>=ystart && grawitacja>0 {sekwencja=0;y=ystart}}
    ...
    if wyskok_sekwencja=1 {x-=0.5;y+=wyskok;wyskok+=0.1;if wyskok>=-5 {wyskok=-5}; powiekszator+=0.01
    if y<=__view_get( e__VW.YView, 0 )-300 {SXMS_SFX_PlayExt(406,((x-__view_get( e__VW.XView, 0 ))/800)*255,global.glosnosc_dzwieku,-1,0,0);instance_destroy();instance_create(x,y,o_WIELKI_ZJADACZOR_LECI)}
