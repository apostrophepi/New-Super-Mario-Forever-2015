...
if global.pauza=0
    ...
    if animsek=1
        ...
        timer+=1
        if timer>timer_max {timer=0;timer_max=0;animsek=2;losuj_kierunek=random(100);if losuj_kierunek<=50 {kierunek=1}; if losuj_kierunek>50 {kierunek=-1};timer_max=100+random(100);szybkosc=2.5+random(2) }
        }
    if animsek=2
        {
