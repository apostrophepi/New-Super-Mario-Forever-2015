...
wielkosc*(1*global.ekran_size_act+sin(degtorad(stream2/2))/20)+sin(degtorad(stream2))/20*(pompon2+1),-1*wielkosc*(1*global.ekran_size_act-sin(degtorad(stream2/2))/20)-sin(degtorad(stream2))/20*(pompon2+1),sin(degtorad(stream2))*3+sin(degtorad(stream2))/20*(pompon2/2+1)*10,c_white,0.2) // 2
...
wielkosc*(1.1*global.ekran_size_act+sin(degtorad(stream4/2+180))/20),-1*wielkosc*(1.1*global.ekran_size_act+sin(degtorad(stream4/2+180))/20),33+sin(degtorad(stream4))*2,c_white,0.2) // 4
...
wielkosc*(1*global.ekran_size_act+sin(degtorad(stream3/2))/20)+sin(degtorad(stream3/2+180))/20,-1*wielkosc*(1*global.ekran_size_act+sin(degtorad(stream3/2))/20)-sin(degtorad(stream3/2+180))/20,sin(degtorad(stream3+180))*5,c_white,0.2) // 3
...
wielkosc*1*global.ekran_size_act+sin(degtorad(stream1/2+180))/20+sin(degtorad(stream1))/20*(pompon1+1),-1*wielkosc*(1*global.ekran_size_act+sin(degtorad(stream1/2+180))/20)-sin(degtorad(stream1))/20*(pompon1+1),sin(degtorad(stream1+90))*8,c_white,0.2) //1
