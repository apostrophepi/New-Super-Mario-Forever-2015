if point_distance(x,y,global.ekran_srodek_x,global.ekran_srodek_y)<=global.odleglosc_ekranu*2
    ...
    if czas>=172000 || timer=0{czas=0
    sampel=SXMS_SFX_PlayExt(321,((x-__view_get( e__VW.XView, 0 ))/800)*255,global.glosnosc_dzwieku,-1,0,0)
    timer=1}
 ...
 if graj_od_nowa2>=10 {graj_od_nowa2=0;sampel=SXMS_SFX_PlayExt(321,((x-__view_get( e__VW.XView, 0 ))/800)*255,global.glosnosc_dzwieku,-1,0,0)}
    ...
    SXMS_SFX_VolumeAbsolute(sampel,((450-(koko))/300)*255)
