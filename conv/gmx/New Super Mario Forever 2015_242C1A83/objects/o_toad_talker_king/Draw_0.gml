...
draw_sprite_ext(s_toad_talker_4_king,0,x+20,y+ygrek,1,1,sin(degtorad(stream))*2,c_white,1)
...
if generuj_dialog=1
    {
    if x>obj_mario.x-100 && x<obj_mario.x+100 && y>obj_mario.y-100 && y<obj_mario.y+100 && obj_mario.sekwencja=0
        {
