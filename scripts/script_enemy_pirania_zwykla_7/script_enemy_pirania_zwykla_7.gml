function script_enemy_pirania_zwykla_7() {
	if global.pauza=0
	    {
	    ...
	    // zjadanie MARIO
	    if sekwencja=1 && anim<=-120 && collision_circle(sin(degtorad(desdir+180))*5+x+sin(degtorad(kierunek_wychodzenia+180))*poszedl,cos(degtorad(desdir+180))*5+y+cos(degtorad(kierunek_wychodzenia+180))*poszedl,50,obj_mario,0,1)
	        {sekwencja=10}
	...
	draw_sprite_ext(s_pirania_5,0,sin(degtorad(kierunek+180))*5+x+sin(degtorad(kierunek_wychodzenia+180))*poszedl,cos(degtorad(kierunek+180))*5+y+cos(degtorad(kierunek_wychodzenia+180))*poszedl,0.75,0.75,kierunek_wychodzenia+sin(degtorad(anim+180))*20-20+kierunek-90-kierunek_wychodzenia+20,kolorek,1)
	draw_sprite_ext(s_pirania_5,0,sin(degtorad(kierunek))*5+x+sin(degtorad(kierunek_wychodzenia+180))*poszedl,cos(degtorad(kierunek))*5+y+cos(degtorad(kierunek_wychodzenia+180))*poszedl,-0.75,0.75,kierunek_wychodzenia-sin(degtorad(anim+180))*20+20+kierunek-90-kierunek_wychodzenia-20,kolorek,1) 
