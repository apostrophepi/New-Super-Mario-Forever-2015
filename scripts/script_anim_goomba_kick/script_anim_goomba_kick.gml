function script_anim_goomba_kick() {
	if animacja=18{
	// kopniak kopanie kop w goombe
	if size2=1{
	...
	draw_sprite_ext(global.gfx_mario_leg[anim],0,x+((sin(degtorad(20+kat+globalny_kat))*35/3)*size),y+(cos(degtorad(20+kat+globalny_kat))*35/3)*size,size*size2,size,80-kopniak,power_star_kolorek,1+miganie)
	...
	draw_sprite_ext(global.gfx_mario_leg[anim],0,x+((sin(degtorad(-22+kat+globalny_kat))*30/3)*size),y+(cos(degtorad(-22+kat+globalny_kat))*30/3)*size,size*size2,size,-80+kopniak,power_star_kolorek,1+miganie)
	...
	draw_sprite_ext(global.gfx_mario_mrugacz,0,x+((sin(degtorad(180+kat+globalny_kat))*30/3)*size),y+(cos(degtorad(180+kat+globalny_kat))*30/3)*size+sin(degtorad(run_kat)),(0.75+size/4)*size2,(0.75+size/4),(kat+run_pochylenie)*size2,power_star_kolorek,mrugacz[2]+miganie)
	...
	if niesie=1 {draw_sprite_ext(global.gfx_mario_arm[anim],0,x+((sin(degtorad(-150-kat+globalny_kat))*30/3)*size),schylanie/5+y+(cos(degtorad(-150-kat+globalny_kat))*30/3)*size,size*size2,size,((kat+sin(degtorad(run_kat))*run_promien/2-15-schylanie*2)*strzelanie+strzelanie2)*size2-240*size2,power_star_kolorek,1+miganie)}
	if niesie=0 {draw_sprite_ext(global.gfx_mario_arm[anim],0,-run_pochylenie*size2/10+x+((sin(degtorad(-150-kat+globalny_kat))*30/3)*size),y+(cos(degtorad(-150-kat+globalny_kat))*30/3)*size,size*size2,-size,((kat+sin(degtorad(run_kat))*run_promien/2-15+jump)*strzelanie+strzelanie2)*size2+schylak,power_star_kolorek,1+miganie)}
	draw_sprite_ext(global.gfx_mario_leg[anim],0,x+((sin(degtorad(-20-kat+globalny_kat))*35/3)*size),y+(cos(degtorad(-20-kat+globalny_kat))*35/3)*size,size*size2,size,-80,power_star_kolorek,1+miganie)
	draw_sprite_ext(global.gfx_mario_ogon[anim],0,x,sin(degtorad(hamowanie/2))*3+y+sin(degtorad(run_kat))/2,size*size2,size,(kat+sin(degtorad(run_kat))+run_pochylenie+strzelanie2/5+sin(degtorad(hamowanie/2))*5)*size2+60*size2+ogon_uderzak+sin(degtorad(ogon_merda))*20,power_star_kolorek,1+miganie)
	draw_sprite_ext(global.gfx_mario_chest[anim],0,x,y+sin(degtorad(run_kat))/2,size*size2,size,kat+sin(degtorad(run_kat))+run_pochylenie*size2+strzelanie2/10,power_star_kolorek,1+miganie)
	draw_sprite_ext(global.gfx_mario_leg[anim],0,x+((sin(degtorad(+22-kat+globalny_kat))*30/3)*size),y+(cos(degtorad(+22-kat+globalny_kat))*30/3)*size,size*size2,size,80,power_star_kolorek,1+miganie)
	draw_sprite_ext(global.gfx_mario_head[anim],0,x+((sin(degtorad(-180-kat+globalny_kat))*30/3)*size),y+(cos(degtorad(-180-kat+globalny_kat))*30/3)*size+sin(degtorad(run_kat)),(0.75+size/4)*size2,(0.75+size/4),(kat+run_pochylenie+jump/5+strzelanie2/10)*size2,power_star_kolorek,1+miganie)
	...
	if kopniak<=10 {kopniak=0;if obj_mario.sekwencja=1 {animacja=1}; if obj_mario.sekwencja=0 {animacja=0}}
