function script_enemy_pirania_zwykla_9() {
	if global.pauza=0
	    {
	    ...
	    if sekwencja=1 && poszedl>=dlugosc*40 && timer=30 {SXMS_SFX_PlayExt(73,((x-__view_get( e__VW.XView, 0 ))/800)*255,global.glosnosc_dzwieku,-1,0,0);lolo=instance_create(x+sin(degtorad(kierunek_wychodzenia+180))*dlugosc*40,y+cos(degtorad(kierunek_wychodzenia+180))*dlugosc*40,o_pirania_fireball_2);lolo.direction=kierunek_wychodzenia+90+random(30)-random(30);lolo.speed=5+random(2)-random(2)}
	    if sekwencja=1 && poszedl>=dlugosc*40 && timer=60 {SXMS_SFX_PlayExt(73,((x-__view_get( e__VW.XView, 0 ))/800)*255,global.glosnosc_dzwieku,-1,0,0);lolo=instance_create(x+sin(degtorad(kierunek_wychodzenia+180))*dlugosc*40,y+cos(degtorad(kierunek_wychodzenia+180))*dlugosc*40,o_pirania_fireball_2);lolo.direction=kierunek_wychodzenia+90+random(30)-random(30);lolo.speed=5+random(2)-random(2)}
	    if sekwencja=1 && poszedl>=dlugosc*40 && timer=90 {SXMS_SFX_PlayExt(73,((x-__view_get( e__VW.XView, 0 ))/800)*255,global.glosnosc_dzwieku,-1,0,0);lolo=instance_create(x+sin(degtorad(kierunek_wychodzenia+180))*dlugosc*40,y+cos(degtorad(kierunek_wychodzenia+180))*dlugosc*40,o_pirania_fireball_2);lolo.direction=kierunek_wychodzenia+90+random(30)-random(30);lolo.speed=5+random(2)-random(2)}
            
        
        
	    if sekwencja=1 && poszedl>=dlugosc*40 && timer>120 {timer=0;sekwencja=2}
