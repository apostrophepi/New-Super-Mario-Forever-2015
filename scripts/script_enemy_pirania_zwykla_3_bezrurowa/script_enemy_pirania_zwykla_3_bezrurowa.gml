function script_enemy_pirania_zwykla_3_bezrurowa() {
	if global.pauza=0
	    {
	    ...
	    // algorytmy
	    if point_distance(x,y,global.ekran_srodek_x,global.ekran_srodek_y)<=global.odleglosc_ekranu*1.5 {timer+=1
	    ...
	    if sekwencja=1 && poszedl>=dlugosc*40 && timer=30
	        ...
	        lolo=instance_create(x+sin(degtorad(kierunek_wychodzenia+180))*dlugosc*40,y+cos(degtorad(kierunek_wychodzenia+180))*dlugosc*40,o_pirania_fireball); lolo.direction=desdir;lolo.speed=3}
	...
	kolorek=make_color_rgb(255,240,240)    
	draw_sprite_ext(s_pirania_1,0,x+sin(degtorad(kierunek_wychodzenia+180))*poszedl,y+cos(degtorad(kierunek_wychodzenia+180))*poszedl,1.3,1.3,kierunek_wychodzenia+sin(degtorad(anim+180))*20-20+kierunek-90-kierunek_wychodzenia,kolorek,1)
	draw_sprite_ext(s_pirania_2,0,x+sin(degtorad(kierunek_wychodzenia+180))*poszedl,y+cos(degtorad(kierunek_wychodzenia+180))*poszedl,1.3,1.3,kierunek_wychodzenia-sin(degtorad(anim+180))*20+20+kierunek-90-kierunek_wychodzenia,kolorek,1) 
	draw_sprite_ext(s_pirania_3,0,x+sin(degtorad(kierunek_wychodzenia+180))*poszedl,y+cos(degtorad(kierunek_wychodzenia+180))*poszedl,1.3,1.3,kierunek_wychodzenia+kierunek-90,c_white,1)  
	...
	draw_sprite_ext(s_pirania_1,0,x+sin(degtorad(kierunek_wychodzenia+180))*poszedl,y+cos(degtorad(kierunek_wychodzenia+180))*poszedl,1.3,1.3,kierunek_wychodzenia+sin(degtorad(anim+180))*20-20+kierunek-90-kierunek_wychodzenia,c_white,oberwal)
	draw_sprite_ext(s_pirania_2,0,x+sin(degtorad(kierunek_wychodzenia+180))*poszedl,y+cos(degtorad(kierunek_wychodzenia+180))*poszedl,1.3,1.3,kierunek_wychodzenia-sin(degtorad(anim+180))*20+20+kierunek-90-kierunek_wychodzenia,c_white,oberwal) 
	draw_sprite_ext(s_pirania_3,0,x+sin(degtorad(kierunek_wychodzenia+180))*poszedl,y+cos(degtorad(kierunek_wychodzenia+180))*poszedl,1.3,1.3,kierunek_wychodzenia+kierunek-90,c_white,oberwal)  
