function script_enemy_troopa_red() {
	if global.pauza=0{
	...
	// odbijanie sie od krawedzi

	if !place_meeting(x+40*kierunek,y+40,obj_wall) && !place_meeting(x+40*kierunek,y+40,o_subplatform) {kierunek=kierunek*-1}
	...
	if kill=10
	    ...
	    lolo.grafika=global.gfx_troopa_shell_2
	...
	draw_sprite_ext(global.gfx_troopa_leg_2,0,x+18,y+20+sin(stream),kierunek,1,sin(stream)*40+360,c_white,1)
	draw_sprite_ext(global.gfx_troopa_3,0,x+16,y+sin(stream)*2,kierunek,1,sin(stream)*5+360,c_white,1)
	draw_sprite_ext(global.gfx_troopa_leg_2,0,x+18,y+20+sin(stream),kierunek,1,sin(-stream)*40+360,c_white,1)
