function script_enemy_pirania_zwykla_5() {
	if global.pauza=0
	    {
	...
	kolorek=make_color_rgb(250,250,20)    
	draw_sprite_ext(s_pirania_1,0,sin(degtorad(kierunek+180))*5+x+sin(degtorad(kierunek_wychodzenia+180))*poszedl,cos(degtorad(kierunek+180))*5+y+cos(degtorad(kierunek_wychodzenia+180))*poszedl,1.3,1.3,kierunek_wychodzenia+sin(degtorad(anim+180))*20-20+kierunek-90-kierunek_wychodzenia,kolorek,1)
	draw_sprite_ext(s_pirania_2,0,sin(degtorad(kierunek))*5+x+sin(degtorad(kierunek_wychodzenia+180))*poszedl,cos(degtorad(kierunek))*5+y+cos(degtorad(kierunek_wychodzenia+180))*poszedl,1.3,1.3,kierunek_wychodzenia-sin(degtorad(anim+180))*20+20+kierunek-90-kierunek_wychodzenia,kolorek,1) 
	draw_sprite_ext(s_pirania_3,0,sin(degtorad(kierunek-90))*5+x+sin(degtorad(kierunek_wychodzenia+180))*poszedl,cos(degtorad(kierunek-90))*5+y+cos(degtorad(kierunek_wychodzenia+180))*poszedl,1.5,1.5,kierunek_wychodzenia+kierunek-90,kolorek,1)  
