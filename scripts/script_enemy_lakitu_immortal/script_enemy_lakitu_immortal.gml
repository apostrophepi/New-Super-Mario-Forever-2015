function script_enemy_lakitu_immortal() {
	if global.pauza=0
	    {
	    if energy<=0 {kill=10}
	    if aktywna=0
	    ...
	    if aktywna=1
	        ...
	        if random(100)>98 {effect_create_above(ef_smoke,x,y,2,c_white)}
	...
	draw_sprite_ext(global.gfx_lakitus_5,0,x,y,kierunek-sin(degtorad(anim*4))/20,1+sin(degtorad(anim*4))/20,-ixor*2+360,c_white,1)
