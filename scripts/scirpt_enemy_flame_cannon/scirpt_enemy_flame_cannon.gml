function scirpt_enemy_flame_cannon() {
	if global.pauza=0 {
	...
	if reload>=reload_shot
	    {
	    SXMS_SFX_PlayExt(71,((x-__view_get( e__VW.XView, 0 ))/800)*255,global.glosnosc_dzwieku,-1,0,0)
	    reload=0
	    koko=instance_create(x+20+sin(degtorad(kierunek+90))*25,y+20+cos(degtorad(kierunek+90))*25,o_enemy_flame)
