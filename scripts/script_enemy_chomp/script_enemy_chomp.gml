function script_enemy_chomp() {
	...
	if point_distance(x,y,global.ekran_srodek_x,global.ekran_srodek_y)<=global.odleglosc_ekranu*1.5 {
	draw_sprite_ext(s_chomp_1,0,x+20,y+20,kierunek,1,sin(degtorad(-stream*kierunek))*20-20*kierunek,c_white,1)
	draw_sprite_ext(s_chomp_2,0,x+20,y+20,kierunek,1,sin(degtorad(stream*kierunek))*20+20*kierunek,c_white,1)
	draw_sprite_ext(s_chomp_3,0,x+20,y+20,kierunek,1,0,c_white,1)
	draw_sprite_ext(s_chomp_4,0,x+20,y+20,kierunek,1,sin(degtorad(stream*kierunek))*20+20*kierunek,c_white,1)
