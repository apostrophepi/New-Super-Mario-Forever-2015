function script_enemy_troopa_2plus() {
	if global.pauza=0{
	...
	if kill=1
	    ...
	    lolo=instance_create(x,y,o_enemy_dry_bones);
	    lolo.kill=10     
	...
	//draw_sprite_ext(s_dry_bones_2,0,x+16,y+sin(stream)*2,kierunek,1,sin(stream)*5+360,c_white,1)
	draw_sprite_ext(s_dry_bones_1,0,x+16,y+sin(stream)*2,kierunek,1,sin(stream)*5+360,c_white,1)
	draw_sprite_ext(s_dry_bones_3,0,x+18,y+20+sin(stream),kierunek,1,sin(-stream)*10+360+kierunek*-20,c_white,1)
	draw_sprite_ext(s_dry_bones_3,0,x+18,y+20+sin(stream),kierunek,1,sin(stream)*10+360+kierunek*-20,c_white,1)
	draw_sprite_ext(s_dry_bones_4,0,x+18,y+5+sin(stream),kierunek,1,sin(stream)*40+360,c_white,1)
	draw_sprite_ext(global.gfx_wings,0,x+18-10*kierunek,y-15+sin(stream),kierunek*0.65,0.65,sin(stream*2)*30+360-20*kierunek,c_white,1)
	draw_sprite_ext(s_dry_bones_2,0,x+18+kierunek*15,y+20+sin(stream)-45,kierunek,1,sin(stream)*10+360+kierunek*-20,c_white,1)
	}
