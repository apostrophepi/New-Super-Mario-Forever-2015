function script_enemy_pirania_zwykla_4() {
	if global.pauza=0
	    {
	    ...
	    if sekwencja=1 && poszedl>=dlugosc*40 && timer=30
	        ...
	        lolo=instance_create(x+sin(degtorad(kierunek_wychodzenia+180))*dlugosc*40,y+cos(degtorad(kierunek_wychodzenia+180))*dlugosc*40,o_pirania_fireball); lolo.direction=desdir+32;lolo.speed=2;
	        lolo=instance_create(x+sin(degtorad(kierunek_wychodzenia+180))*dlugosc*40,y+cos(degtorad(kierunek_wychodzenia+180))*dlugosc*40,o_pirania_fireball); lolo.direction=desdir-32;lolo.speed=2;
	        }
