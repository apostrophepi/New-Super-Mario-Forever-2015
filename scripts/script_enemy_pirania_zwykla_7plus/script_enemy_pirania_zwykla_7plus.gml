function script_enemy_pirania_zwykla_7plus() {
	if global.pauza=0
	    {
	    ...
	    // zjadanie MARIO WYLACZONE!!!!
	    if sekwencja=1 && anim=999999 && collision_circle(sin(degtorad(desdir+180))*5+x+sin(degtorad(kierunek_wychodzenia+180))*poszedl,cos(degtorad(desdir+180))*5+y+cos(degtorad(kierunek_wychodzenia+180))*poszedl,80,obj_mario,0,1)
	        {sekwencja=10}
