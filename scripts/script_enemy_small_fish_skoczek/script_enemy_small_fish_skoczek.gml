function script_enemy_small_fish_skoczek() {
	if global.pauza=0{


	seened=1
	if point_distance(x,y,global.ekran_srodek_x,global.ekran_srodek_y)>global.odleglosc_ekranu*1.3 {instance_destroy()}
