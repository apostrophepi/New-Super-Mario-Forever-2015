function script_enemy_spikey_panzer() {
	if global.pauza=0{
	...
	draw_sprite_ext(s_spikey_4,0,x+16+10*kierunek,y+20+(sin(stream*2)*4)*kierunek*-1,kierunek,1,sin(stream*2)*10,c_white,1)
	draw_sprite_ext(s_spikey_4,0,x+16-15*kierunek,y+30,kierunek/1.80,0.8,sin(stream*2)*20,c_white,1)
	draw_sprite_ext(s_spikey_4,0,x+16-10*kierunek,y+30,kierunek/1.80,0.8,sin(stream*2)*20*-1,c_white,1)
	draw_sprite_ext(s_spikey_4,0,x+16+1*kierunek,y+20,kierunek,1,sin(stream*2)*10*-1,c_white,1)
	draw_sprite_ext(s_spikey_3,0,x+16,y+18+sin(stream)*2,kierunek,1,sin(stream)*5+360,c_white,1)}
