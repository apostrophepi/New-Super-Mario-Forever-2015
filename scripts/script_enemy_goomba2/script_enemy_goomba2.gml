function script_enemy_goomba2() {
	...
	draw_sprite_ext(global.gfx_goomba,0,x+16,y+15+sin(stream)*2,kierunek,1,sin(stream)*5+360,c_white,1)
	draw_sprite_ext(global.gfx_goomba_leg,0,x+5,y+35+sin(stream)*4,kierunek,1,0,c_white,1)
	draw_sprite_ext(global.gfx_goomba_leg,0,x+24,y+35+sin(stream*-1)*4,-kierunek,1,0,c_white,1)}
