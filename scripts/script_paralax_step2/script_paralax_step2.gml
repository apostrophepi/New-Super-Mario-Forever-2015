function script_paralax_step2() {
	...
	if point_distance(x,y,global.ekran_srodek_x,global.ekran_srodek_y)<=global.odleglosc_ekranu*visible_size*1.2
	    {
	    draw_sprite_ext(sprite_index,0,x,y,image_xscale,image_yscale,image_angle+sin(degtorad(stream))*promien_bujania,c_white,image_alpha)
