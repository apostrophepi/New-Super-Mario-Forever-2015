function script_enemy_bulletbill() {
	...
	if kill=1
	    ...
	    if rodzaj=0 {lolo.grafika=s_bullet}
	    if rodzaj=1 {lolo.grafika=s_bulletred}
	...
	if global.graphics>=4 && rodzaj<>2 {draw_sprite_ext(s_spikey_10,0,x,y,kierunek*ogonek,1,0,c_white,0.5)}
