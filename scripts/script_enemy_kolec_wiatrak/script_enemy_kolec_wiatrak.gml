function script_enemy_kolec_wiatrak() {
	...
	if samplowanie=0 {sampel=SXMS_SFX_PlayExt(103,((x-__view_get( e__VW.XView, 0 ))/800)*255,global.glosnosc_dzwieku/5,-1,0,0);samplowanie=1}
